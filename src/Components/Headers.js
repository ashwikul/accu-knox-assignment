  ...
  return (
    <div className="flex justify-between items-start">
      ...
      <div className="flex space-x-2">
        <button className="rounded-md bg-white px-2 py-1 border border-slate-300 text-slate-600">Add Widget +</button>
        ...
        <button className="relative rounded-md bg-white px-2 py-1 border border-blue-600 text-slate-600">
          <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3 my-1">
            <span className="text-gray-500 sm:text-sm"><BsFillClockFill color="blue" />
            </span>
            <div className="border-l-2 border-blue-600 h-full ml-1"></div>
          </div>
          <select name="timeFrame" id="timeFrame" className="py-1.5 pl-7 pr-2 text-blue-600 w-fit border-none">
